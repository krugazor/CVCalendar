    ...
    public override func presentPreviousView(_ view: UIView?) {
        if presentationEnabled {
            ...
            UIView.animate(withDuration: 0.5, delay: 0,
                ...
                extra.frame.origin.x  =                 extra.frame.origin.x  +  self.scrollView.frame.width
                presented.frame.origin.x  =                 presented.frame.origin.x  +  self.scrollView.frame.width
                previous.frame.origin.x  =                 previous.frame.origin.x  +  self.scrollView.frame.width
    ...
    public override func presentNextView(_ view: UIView?) {
        if presentationEnabled {
            ...
            UIView.animate(withDuration: 0.5, delay: 0,
                ...
                extra.frame.origin.x  =                 extra.frame.origin.x  -  self.scrollView.frame.width
                presented.frame.origin.x  =                 presented.frame.origin.x  -  self.scrollView.frame.width
                following.frame.origin.x  =                 following.frame.origin.x  -  self.scrollView.frame.width
