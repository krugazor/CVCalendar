...
private let yearUnit = Calendar.Unit.year
private let monthUnit = Calendar.Unit.month
private let weekUnit = Calendar.Unit.weekOfMonth
private let weekdayUnit = Calendar.Unit.weekday
private let dayUnit = Calendar.Unit.day
...
public final class CVCalendarManager {
    ...
    public static func componentsForDate(_ date: Foundation.Date) -> DateComponents {
        ...
        let components = Calendar.current().components(units, from: date)
